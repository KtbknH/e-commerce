...
public interface ProductRepository extends JpaRepository<Product, UUID>, JpaSpecificationExecutor<Product> {
    ...
    Page<Product> findByCategoryIdAndIsActiveTrueAndDeletedAtIsNull(UUID categoryId, Pageable pageable);
    ...
    @Query("SELECT DISTINCT p.brand FROM Product p WHERE p.brand IS NOT NULL AND p.isActive = true AND p.deletedAt IS NULL ORDER BY p.brand")
