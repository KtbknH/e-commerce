...
public class ProductController {
  ...
  public ResponseEntity<ApiResponse> searchProducts(
    ...
    PagedResponse<ProductListResponse> result =
        productService.searchProducts(
            search, categoryId, minPrice, maxPrice, size, color, inStockOnly,
            isFeatured, onSale, page, pageSize, sortBy, sortDir);
  ...
  public ResponseEntity<ApiResponse> toggleProductStatus(@PathVariable UUID id) {
    ...
    return ResponseEntity.ok(
        ApiResponse.success(toggled, "Statut du produit modifié"));
  }
  ...
  public ResponseEntity<ApiResponse> getLowStockProducts() {
    ...
    return ResponseEntity.ok(
        ApiResponse.success(products, "Produits en stock bas"));
  }
}