...
public class CategoryController {
    ...
    public ResponseEntity<ApiResponse> getSubCategories(@PathVariable UUID id) {
        ...
        return ResponseEntity.ok(ApiResponse.success(children, "Sous-catégories récupérées"));
    }
    ...
    public ResponseEntity<ApiResponse> getCategoriesByType(@PathVariable String type) {
        ...
        return ResponseEntity.ok(ApiResponse.success(categories, "Catégories par type récupérées"));
    }
